...
export default function CustomerDetailPage() {
  ...
  const selectedCustomerType = CUSTOMER_TYPES.find(type => type.name === formData.customerType) || null;
  ...
  const handleSubmit = useCallback(() => {
    ...
    try {
      ...
      // Here you would make an API call to update the customer
      setTimeout(() => {
        router.push('/dashboard/customers?refresh=true&action=updated');
      }, 1500);
    } catch (error) {
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              <FormControl fullWidth>
                <Autocomplete
                  ...
                  onChange={handleAutocompleteChange('customerType')}
                  renderInput={(params) => (
